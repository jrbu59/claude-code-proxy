...
def main():
    if len(sys.argv) > 1 and sys.argv[1] == "--help":
        ...
        print("")
        print("Usage: python src/main.py [--env-file <path> | --env <name>] [--help]")
        print("")
        ...
        print("")
        print("Environment file selection:")
        print("  --env-file <path>  Load variables from an explicit file, e.g. .env.azure")
        print("  --env <name>       Load variables from .env.<name>, e.g. --env ollama -> .env.ollama")
        print("  CLAUDE_PROXY_ENV_FILE=<path> can be used as well (highest priority)")
        print("")
        print("Model mapping:")
